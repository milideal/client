  ...
  return (
    <div className="vbox pack ml(30) mr(30)">
      <div className="vbox w(370)">
        <span className="font(32) GmarketSans 900 c(#363636)">
          총 1,214개의
          <br /> 군인 할인점들이 있어요.
        </span>
      ...
      <div className="wrap w(370) mt(50) mb(50)">
        <span className="font(16) GmarketSans 900 c(#363636) mb(10)">
          어디서 찾아볼까요?
        </span>
        <div className="w(370) h(40) b(2/#505050) r(20) pl(12) hbox">
          ...
          <input
            ...
            value={keyword}
            className="placeholder::font(14)+900+c(#999999)+NanumGothic NanumGothic font(14) 900 c(#363636)) w(300)"
            placeholder="강남구 삼성동"
          />
        </div>
