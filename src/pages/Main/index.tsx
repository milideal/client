  ...
  return (
    <div className="vbox pack ml(30) mr(30)">
      <div className="vbox w(370)">
        <span className="font(32) GmarketSans 900 c(#363636) dark:c(#fff)">
          총 1,214개의
          <br /> 군인 할인점들이 있어요.
        </span>
      ...
      <div className="wrap w(370) mt(50) mb(50)">
        <span className="font(16) GmarketSans 900 c(#363636) dark:c(#fff) mb(10)">
          어디서 찾아볼까요?
        </span>
        <div className="w(370) h(40) b(2/#505050) r(20) pl(12) hbox">
          ...
          <input
            ...
            value={keyword}
            className="placeholder::font(14)+900+c(#999999)+NanumGothic NanumGothic font(14) 900 c(#363636) dark:c(#fff) w(300) dark:bg(#000.0)"
            placeholder="강남구 삼성동"
          />
        </div>
      ...
      <div className="vbox w(370) r(5) b(1/#D9D9D9) box-shadow(0/0/20/#000.1) pl(24) pt(14) pb(14)">
        <span className="font(14) 900 c(#363636) dark:c(#fff)">
          할인점 추가하기
        </span>
